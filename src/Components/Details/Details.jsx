...
export default function Details() {
  let { trendingMovies, trendingTvs, trendingPersons } =
  ...
  let getItemDetails = async () => {
    let { data } = await axios.get(
      `https://api.themoviedb.org/3/${params.mediaType}/${params.id}?api_key=4507261fca454568e6ba45d3e6be7831&language=en-US`
    );
    setItemDetails(data);
  };
              ...
              {params.mediaType == "person" ? (
                <>
                  ...
                  {itemDetails.homepage ? (
                    <Link target="_blank" to={itemDetails.homepage}>
                ...
                <>
                  ...
                  <p>Voute count : {itemDetails.vote_count}</p>
